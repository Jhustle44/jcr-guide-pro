...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        // Setup Asset Loader to serve local files over a virtual https:// domain
        // This is critical for modern React/Vite apps to work (ES Modules support)
        ...
        // Load using the virtual domain instead of file:///
    ...
    private void setupWebViewClients() {
        mWebView.setWebViewClient(new WebViewClient() {
            ...
            public WebResourceResponse shouldInterceptRequest(WebView view, WebResourceRequest request) {
                // Intercept requests and serve them via our AssetLoader
